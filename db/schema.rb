...
ActiveRecord::Schema.define(version: 20140603180717) do
  ...
  add_index "ownerships", ["business_id"], name: "index_ownerships_on_business_id", using: :btree
